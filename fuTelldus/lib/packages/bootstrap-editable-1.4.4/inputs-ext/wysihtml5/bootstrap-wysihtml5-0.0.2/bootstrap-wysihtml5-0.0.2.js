!function($, wysi) {
    ...
    var tpl = {
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>" +
                ...
                "</div>" +
              "</div>" +
              "<a class='btn" + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class='.glyphicon .glyphicon-share'></i></a>" +
            "</li>";
        },
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'>" +
                ...
                "</div>" +
              "</div>" +
              "<a class='btn" + size + "' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' tabindex='-1'><i class='.glyphicon .glyphicon-picture'></i></a>" +
            "</li>";
        },
        ...
        "html": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btn" + size + "' data-wysihtml5-action='change_view' title='" + locale.html.edit + "' tabindex='-1'><i class='.glyphicon .glyphicon-pencil'></i></a>" +
              "</div>" +
            "</li>";
        },
